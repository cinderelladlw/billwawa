...
static unsigned int sqlctx = 4723;
...
{12,4130,1,0,0,
5,0,0,0,0,0,27,31,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,66,0,4,40,0,0,4,1,0,1,0,2,9,0,0,2,4,0,0,2,4,0,0,1,3,0,0,
67,0,0,3,0,0,30,53,0,0,0,0,0,1,0,
82,0,0,4,0,0,32,62,0,0,0,0,0,1,0,
};
...
int main()
{
  /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    int emp_number;
    /* VARCHAR emp_name[15]; */ 
struct { unsigned short len; unsigned char arr[15]; } emp_name;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select ENAME ,SAL ,COMM into :b0,:b1,:b2  from EMP where \
EMPNO=:b3";
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (         void  *)&commission;
